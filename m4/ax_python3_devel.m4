...
AC_DEFUN([AX_PYTHON3_DEVEL],[
    ...
    if test -z "$PYTHON3" ; then
      AC_PATH_PROGS([PYTHON3], [python3 python311 python3.11 python310 python3.10 python39 python3.9 python38 python3.8 python37 python3.7 python36 python3.6 python35 python3.5 python34 python3.4], [no])
    fi
